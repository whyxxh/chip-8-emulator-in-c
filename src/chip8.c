...
int checkKeyPress(Chip8 *chip8) {
  ...
  if (IsKeyPressed(KEY_ONE)) { chip8->kb[0x1] = 1; printf("Key 1 pressed\n"); }
  if (IsKeyPressed(KEY_TWO)) { chip8->kb[0x2] = 1; printf("Key 2 pressed\n"); }
  if (IsKeyPressed(KEY_THREE)) { chip8->kb[0x3] = 1; printf("Key 3 pressed\n"); }
  if (IsKeyPressed(KEY_FOUR)) { chip8->kb[0xC] = 1; printf("Key 4 pressed\n"); }

  if (IsKeyPressed(KEY_Q)) { chip8->kb[0x4] = 1; return 0x4; }
  if (IsKeyPressed(KEY_W)) { chip8->kb[0x5] = 1; return 0x5; }
  if (IsKeyPressed(KEY_E)) { chip8->kb[0x6] = 1; return 0x6; }
  if (IsKeyPressed(KEY_R)) { chip8->kb[0xD] = 1; return 0xD; }

  if (IsKeyPressed(KEY_A)) { chip8->kb[0x7] = 1; return 0x7; }
  if (IsKeyPressed(KEY_S)) { chip8->kb[0x8] = 1; return 0x8; }
  if (IsKeyPressed(KEY_D)) { chip8->kb[0x9] = 1; return 0x9; }
  if (IsKeyPressed(KEY_F)) { chip8->kb[0xE] = 1; return 0xE; }

  if (IsKeyPressed(KEY_Z)) { chip8->kb[0xA] = 1; return 0xA; }
  if (IsKeyPressed(KEY_X)) { chip8->kb[0x0] = 1; return 0x0; }
  if (IsKeyPressed(KEY_C)) { chip8->kb[0xB] = 1; return 0xB; }
  if (IsKeyPressed(KEY_V)) { chip8->kb[0xF] = 1; return 0xF; }
...
int main(int argc, char *argv[]) {
  ...
  SetTargetFPS(60); // Limit the frame rate to 60 FPS
